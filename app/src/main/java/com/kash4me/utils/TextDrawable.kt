...
//    }
    ...
    interface IShapeBuilder {
        ...
        fun buildRect(text: String?, color: Int = 0xffFFFFFF.toInt()): TextDrawable?
    ...
    init {
        ...
        // text and color
        text =
            if (builder.toUpperCase) builder.text.uppercase(Locale.US) else builder.text
        color = builder.color
